...
def extract_clinical_trial_info(trial_data, output_dir):
    """
    Extracts clinical trial information from trial data.
    ...
    Returns:
        list: A list of extracted clinical trial information.
    """
    extracted_data = []
    ...
    for trial in trial_data:
        ...
        # Extract fields from statusModule
        ...
        # Default values for duration and days until end
        duration_days = None
        days_until_end = None
        ...
        # Parse and calculate dates only if both are present
        ...
        extracted_info = {
            ...
            "nctNumber": nct_id,
            "statusVerifiedDate": status_verified_date,
            "overallStatus": overall_status,
            "startDate": start_date_str,
            "primaryCompletionDate": primary_completion_date_str,
