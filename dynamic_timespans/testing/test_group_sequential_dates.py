# ./testing/test_group_sequential_dates.py
import unittest
import json
import logging
from tools.dynamic_timespans.testing.find_file import find_file
from tools.dynamic_timespans.main import main as generate_output
from tools.dynamic_timespans.trial_utils import get_all_nct_numbers

logging.basicConfig(level=logging.INFO)

class TestGroupSequentialDates(unittest.TestCase):
    ...
    def test_group_sequential_dates(self):
        with open("output_data.json", "r") as file:
            output_data = json.load(file)

        original_trials = self.original_trials
