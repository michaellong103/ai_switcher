# ./dynamic_timespans/testing/test_nct_comparison.py
...
class TestNCTComparison(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Paths to the files to be tested
        self.output_data_path = os.path.join(os.path.dirname(__file__), '../output_data.json')
        ...
        self.dynamic_timespans_path = os.path.join(os.path.dirname(__file__), '../dynamic_timespans.json')
