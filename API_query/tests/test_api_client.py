...
class TestApiClient(unittest.TestCase):
    ...
    @patch('api_actions.api_client.time.sleep', return_value=None)
    def test_query_clinical_trials(self, mock_sleep, mock_post):
        mock_response = mock_post.return_value
        mock_response.json.return_value = {'key': 'value'}
        details = {'Age': '50', 'Gender': 'Female', 'Medical Condition': 'Triple Negative Breast Cancer', 'Location': 'Seattle, WA'}
