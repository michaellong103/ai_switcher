...
from .filtering_questions.filter_questions_assistant import FilterQuestionsAssistant
import logging
...
def create_assistant(assistant_type='default', system_message=None, model='default-model', temperature=0.7, top_p=0.9):
    ...
    elif assistant_type == 'filter_questions':
        logging.info('Creating FilterQuestionsAssistant')
        return FilterQuestionsAssistant(model, temperature, top_p)
